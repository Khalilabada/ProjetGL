...
public class Annonce {
    ...
    protected void onCreate() {
        ...
        determinerTypeHebergement();
    }
    
    @PostLoad
    public void determinerTypeHebergement() {
        if (type_d_hebergement == null) {
            this.typeHebergement = new AppartementType();
            return;
        }
        
        switch (type_d_hebergement) {
            case "Appartement":
                this.typeHebergement = new AppartementType();
                break;
            case "Villa":
                this.typeHebergement = new VillaType();
                break;
            case "Studio":
                this.typeHebergement = new StudioType();
                break;
            default:
                this.typeHebergement = new AppartementType();
        }
    ...
    public double calculerPrixTotal(int nbNuits) {
        return typeHebergement.calculerPrix(this.prix, nbNuits);
    }
    
    public String getDescriptionHebergement() {
        return typeHebergement.getDescription();
    }
    
    public String getIconeHebergement() {
        return typeHebergement.getIcone();
    }
    
    public double getTaxeHebergement() {
        return typeHebergement.getTaxe();
    }
